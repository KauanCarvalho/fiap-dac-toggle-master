...
REQUIRED_VARS := \
	...
	POSTGRES_USER_FLAG_SERVICE \
	POSTGRES_PASSWORD_FLAG_SERVICE \
	POSTGRES_DB_FLAG_SERVICE \
	PORT_FLAG_SERVICE \
	POSTGRES_USER_TARGETING_SERVICE \
	POSTGRES_PASSWORD_TARGETING_SERVICE \
	POSTGRES_DB_TARGETING_SERVICE \
